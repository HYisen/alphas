...
// Extended from that in 8_7, tests are not included.
...
var vault = flag.String("vault", "./web", "the save directory")
...
func main() {
	...
	if cancelled() {
		fmt.Println("search is cancelled, stop the following procedure.")
		return
	}
